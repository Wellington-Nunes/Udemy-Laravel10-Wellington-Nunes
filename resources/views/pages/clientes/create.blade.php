...
@section('content')
    <form class="form" method="POST" action="{{ route('cadastrar.cliente') }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="cep" value="{{ old('cep') }}"
        ...
        <div class="mb-3">
            ...
            <input type="text" id="bairro" value="{{ old('bairro') }}"
        ...
        <div class="mb-3">
            ...
            <input type="text" id="endereco" value="{{ old('endereco') }}" class="form-control @error('endereco') is-invalid @enderror"
                name="endereco">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="logradouro" value="{{ old('logradouro') }}"
